...
import com.adeshcoder.Backingfor30mincoding.Authentication.jwt.exception.UserAlreadyExistsException;
...
public class UserService implements IUserService {
    ...
    public User add(User user) {
        ...
        user.setPassword(passwordEncoder.encode(user.getPassword()));    //used to encode the exist password
